...
<center>
	<font color="black" size="4" style="font-family: avenir">
		...
		<h1 style="color: DodgerBlue">Student Database</h1>

		<body bgcolor="lightgrey">

			<form action="./addemp.php" autocomplete="on" method = "POST" enctype="multipart/form-data">

		  		Student ID:<br> <input style="height:25px;font-size:14pt; color:grey;" type="number" name="student_id" autofocus size="40"><br><br>
		  		...
		  		Current Job:<br> <input style="height:25px;font-size:14pt;color:grey;" type="text" name="current_job"><br><br>
